...
export function getInitialTimezoneItems(date, showLocalTimezone) {
    ...
    const localTimezoneItem = localTimezone !== undefined
        ? {
            ...
            shortName: formatInTimeZone(date !== null && date !== void 0 ? date : CURRENT_DATE, localTimezone.ianaCode, SHORT_NAME_FORMAT_STR),
        }
        : undefined;
    const minimalTimezoneItemsWithNames = mapTimezonesWithNames(date, MINIMAL_TIMEZONE_ITEMS).filter(tz => tz.ianaCode !== (localTimezoneItem === null || localTimezoneItem === void 0 ? void 0 : localTimezoneItem.ianaCode));
