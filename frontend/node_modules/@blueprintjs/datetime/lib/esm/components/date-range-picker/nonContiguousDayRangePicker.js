...
function getBoundedViews(leftView, rightView, minDate, maxDate) {
    const minView = MonthAndYear.fromDate(minDate !== null && minDate !== void 0 ? minDate : null);
    if (minView != null && leftView.isBefore(minView)) {
        return [minView, minView.getNextMonth()];
    }
    const maxView = MonthAndYear.fromDate(maxDate !== null && maxDate !== void 0 ? maxDate : null);
