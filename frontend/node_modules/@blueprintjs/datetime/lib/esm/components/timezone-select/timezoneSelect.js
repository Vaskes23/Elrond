...
export class TimezoneSelect extends AbstractPureComponent {
    ...
    render() {
        ...
        return (_jsx(Select, { className: classNames(Classes.TIMEZONE_SELECT, className), disabled: disabled, fill: fill, inputProps: {
                ...
                ...popoverProps,
                popoverClassName: classNames(Classes.TIMEZONE_SELECT_POPOVER, popoverProps === null || popoverProps === void 0 ? void 0 : popoverProps.popoverClassName),
    ...
    renderButton() {
        ...
        const buttonContent = selectedTimezone !== undefined ? (formatTimezone(selectedTimezone, valueDisplayFormat !== null && valueDisplayFormat !== void 0 ? valueDisplayFormat : TimezoneDisplayFormat.COMPOSITE)) : (_jsx("span", { className: CoreClasses.TEXT_MUTED, children: placeholder }));
        return _jsx(Button, { endIcon: "caret-down", disabled: disabled, text: buttonContent, fill: fill, ...buttonProps });
    }
}
TimezoneSelect.displayName = `${DISPLAYNAME_PREFIX}.TimezoneSelect`;
