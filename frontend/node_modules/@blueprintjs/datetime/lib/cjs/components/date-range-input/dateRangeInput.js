...
class DateRangeInput extends dateFnsLocalizedComponent_1.DateFnsLocalizedComponent {
    constructor(props) {
        ...
        this.handleStartInputRef = (0, core_1.refHandler)(this, "startInputElement", (_a = this.props.startInputProps) === null || _a === void 0 ? void 0 : _a.inputRef);
        this.handleEndInputRef = (0, core_1.refHandler)(this, "endInputElement", (_b = this.props.endInputProps) === null || _b === void 0 ? void 0 : _b.inputRef);
        ...
        this.renderInputGroup = (boundary) => {
            ...
            return ((0, jsx_runtime_1.jsx)(core_1.InputGroup, { autoComplete: "off", disabled: (_a = inputProps === null || inputProps === void 0 ? void 0 : inputProps.disabled) !== null && _a !== void 0 ? _a : this.props.disabled, fill: this.props.fill, ...inputProps, intent: this.isInputInErrorState(boundary) ? core_1.Intent.DANGER : inputProps === null || inputProps === void 0 ? void 0 : inputProps.intent, inputRef: this.getInputRef(boundary), onBlur: handleInputEvent, onChange: handleInputEvent, onClick: handleInputEvent, onFocus: handleInputEvent, onKeyDown: handleInputEvent, onMouseDown: handleInputEvent, placeholder: this.getInputPlaceholderString(boundary), value: this.getInputDisplayString(boundary) }));
        };
