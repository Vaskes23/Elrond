...
class Dialog extends common_1.AbstractPureComponent {
    ...
    render() {
        ...
        return ((0, jsx_runtime_1.jsx)(overlay2_1.Overlay2, { ...overlayProps, className: common_1.Classes.OVERLAY_SCROLL_CONTAINER, childRef: this.childRef, hasBackdrop: true, children: (0, jsx_runtime_1.jsx)("div", { className: common_1.Classes.DIALOG_CONTAINER, ref: (0, common_1.mergeRefs)(containerRef, this.childRef), children: (0, jsx_runtime_1.jsxs)("div", { className: (0, classnames_1.default)(common_1.Classes.DIALOG, className), role: role, "aria-modal": (_a = overlayProps.enforceFocus) !== null && _a !== void 0 ? _a : overlay2_1.OVERLAY2_DEFAULT_PROPS.enforceFocus, "aria-labelledby": this.props["aria-labelledby"] || (title ? this.titleId : undefined), "aria-describedby": this.props["aria-describedby"], style: style, children: [this.maybeRenderHeader(), children] }) }) }));
    }
    validateProps(props) {
        if (props.title == null) {
            if (props.icon != null) {
